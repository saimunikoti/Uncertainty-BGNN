...
from src_bgnn.models.model import SAGE, compute_acc_unsupervised as compute_acc
from src_bgnn.models.negative_sampler import NegativeSampler
...
def run(proc_id, n_gpus, args, devices, data, checkpoint_path, best_model_path):
    # Unpack data
...
def main(args, devices):
    ...
    # elif n_gpus == 1:
    run(0, n_gpus, args, devices, data, cnf.modelpath + "\\current_checkpoint_cora_emb.pt", cnf.modelpath + "\\cora_emb.pt")
    # else:
    #     procs = []
